    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Элегантные шторы в интерьере"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Шторы для вашего дома"}</p>
          ...
          >
            {"Создаем уют"}
            <br />
            <span className="text-orange-200">{"в каждой комнате"}</span>
          </h1>
        </div>
      </div>
